...
const FAQ_DATA: FAQCategory[] = [
    {
        ...
        { q: "¿Cómo pago si soy extranjero?", a: "El pago se realiza mediante transferencia bancaria a través de Global66. Por motivos de seguridad, los datos exactos para realizar la transferencia bancaria (RUT y Número de Cuenta) se te proporcionarán de forma segura en el Paso 3 del Formulario de Inscripción, una vez que hayas ingresado y validado tus datos personales. Para coordinar un pago internacional, escríbanos a congresosociologiaclinica.2026@gmail.com" },
