...
const FAQ_DATA: FAQCategory[] = [
    ...
    },
    {
        ...
        questions: [
        { q: "¿Qué modalidades de participación existen?", a: "Ponencia individual (20 min), simposio temático (90 min, 3-4 presentaciones), póster, y mesa redonda (60 min, 3-5 panelistas)." },
        { q: "¿Cuál es la extensión mínima del resumen?", a: "Ponencias individuales: mínimo 500 palabras. Pósters: mínimo 300 palabras. Simposios: resumen general + resúmenes individuales." },
        ...
        { q: "¿Cuándo sabré si mi propuesta fue aceptada?", a: "Las notificaciones de aceptación se enviarán el 15 de septiembre de 2026, aproximadamente un mes después del cierre de recepción." },
